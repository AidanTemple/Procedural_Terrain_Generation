...
void Position::MoveForward(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_forwardSpeed > (m_frameTime * 0.012f))
		{
			m_forwardSpeed = m_frameTime * 0.012f;
		}
	}
	else
	{
...
void Position::MoveBackward(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_backwardSpeed > (m_frameTime * 0.012f))
		{
			m_backwardSpeed = m_frameTime * 0.012f;
		}
	}
	else
	{
...
void Position::MoveUpward(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_upwardSpeed > (m_frameTime * 0.012f))
		{
			m_upwardSpeed = m_frameTime * 0.012f;
		}
	}
	else
	{
...
void Position::MoveDownward(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_downwardSpeed > (m_frameTime * 0.012f))
		{
			m_downwardSpeed = m_frameTime * 0.012f;
		}
	}
	else
	{
...
void Position::TurnLeft(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_leftTurnSpeed > (m_frameTime * 0.12f))
		{
			m_leftTurnSpeed = m_frameTime * 0.12f;
		}
	}
	else
	{
...
void Position::TurnRight(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_rightTurnSpeed > (m_frameTime * 0.12f))
		{
			m_rightTurnSpeed = m_frameTime * 0.12f;
		}
	}
	else
	{
...
void Position::LookUpward(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_lookUpSpeed > (m_frameTime * 0.12f))
		{
			m_lookUpSpeed = m_frameTime * 0.12f;
		}
	}
	else
	{
...
void Position::LookDownward(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_lookDownSpeed > (m_frameTime * 0.12f))
		{
			m_lookDownSpeed = m_frameTime * 0.12f;
		}
	}
	else
	{
